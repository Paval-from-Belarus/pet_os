...
use crate::memory::{MemoryMappingFlag, ProcessMemory, PageAllocator, VirtualAddress};
...
pub struct UtilsAllocator {
    ...
    kernel_layout: Option<ProcessMemory>,
}
...
impl UtilsAllocator {
    ...
    pub fn configure(&self, _allocator: PageAllocator, _layout: ProcessMemory) {
